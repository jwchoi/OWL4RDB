...
public class OWLMappingMetadata {
	...
	public String getEncodedMappedLiteral(String table, String column, String value) {
		return LiteralMetadata.getMappedTypedLiteral(table, column, value);
	}
	...
	public Set<DBColumn> getMappedDBColumnsToDatatypeOfTypedLiteral(String datatypeOfTypedLiteral) {
		Set<Integer> mappedSQLTypes = DatatypeMap.getMappedJDBCTypes(datatypeOfTypedLiteral);
