...
public class OWLMappingMetadataFactory {
	public static OWLMappingMetadata generateMappingMetaData() {
		OWLMappingMetadata mappingMD = new OWLMappingMetadata(Janus.ontBridge.getOntologyID());
