...
public class LocalDBSchema {
	...
	public String getRegexForXSDDate() {
		return Janus.dbBridge.getRegexForXSDDate();
	}

	public Optional<String> getRegexForXSDDateTime(String tableName, String columnName) {
		return Janus.dbBridge.getRegexForXSDDateTime(catalog, tableName, columnName);
	}

	public Optional<String> getRegexForXSDTime(String tableName, String columnName) {
		return Janus.dbBridge.getRegexForXSDTime(catalog, tableName, columnName);
	}
